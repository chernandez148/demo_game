...
Revision ID: 985c651a14c1
Revises: 
Create Date: 2023-04-27 23:12:08.361253
...
def upgrade():
    ...
    sa.Column('job', sa.Enum('Knight', 'Gunslinger', 'Archer', 'Thief', 'Warrior', 'Berserker', 'Black Mage', 'White Mage'), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('character_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['character_id'], ['characters.id'], name=op.f('fk_job_stats_character_id_characters')),
    sa.PrimaryKeyConstraint('id')
    )
